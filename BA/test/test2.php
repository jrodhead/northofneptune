<!--working copy of header nav before combining swipe and nav functions-->
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
html {background:#333;}
body {overflow:hidden;font-family:economica,sans-serif;color:#fff;}
...
nav.album-nav,nav.user-nav {margin-top:4rem;max-width:0;z-index:1;}
nav.album-nav.active,nav.user-nav.active {max-width:90%;}
.contentwrap {background: #030a0f;
